    ...
    <div class="col-md-12">
      <form id="msform" method="post" action="technicalSanctionSave" modelAttribute="techsanc">
            ...
            <div class="fs-list-full"> 
                ...
                <li><input type="text" name="work" placeholder="Nature of Work" class="form-control mb-md" readonly value="${workInfo.natureOfWork}"></li>
                </ul>
                ...
                <li><input type="text" name="techSanction_no" placeholder="Transaction Number"></li>
                </ul>
                
                <!-- <ul class="fs-list-details">
                <li><p>Date <span class="red">*</span></p></li>
                <li><input type="text" id="date" name="date" class="form-control mb-md hasDatepicker" placeholder="DD/MM/YYYY"></li>
                </ul> -->
                
                <ul class="fs-list-details">
                <li><p>Date <span class="red">*</span></p></li>
                <li><input name="date" id="date" placeholder="DD/MM/YYYY" class="form-control mb-md hasDatepicker">
               </li>
               </ul>
