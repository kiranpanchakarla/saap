    ...
    <div class="col-md-12">
        <form id="msform" method="post" action="agreementDetails" modelAttribute="agreementDetailsObj">
            ...
            <div class="fs-list-full"> 
                ...
                <li><input type="text" id="activityName" name="natureOfWork"  class="form-control mb-md" readonly value="${workInfo.natureOfWork}">
               </li>
               </ul>
               
               <ul class="fs-list-details">
                <li><p>Work Number  <span class="red">*</span></p></li>
                <li><input type="text" id="packageNumber" name="workNo" title="workno" class="form-control mb-md" readonly value="${workInfo.workNo}"></li>
               </ul>
               ...
               <ul class="fs-list-details">
                ...
                <li><input name="bgAmount" id="bgAmount"  class="form-control mb-md"   readonlyvalue="${workInfo.workNo}">
               </li>
               </ul>
               
               <ul class="fs-list-details">
                <li><p>Performance Security Amount(in Rs.)   <span class="red">*</span></p></li>
                <li><input name="performanceSecurityAmount" id="securityAmount" maxlength="10" class="form-control mb-md" >
               </li>
               </ul>
               
               <ul class="fs-list-details">
                <li><p>Site Hand Over Date: <span class="red">*</span></p></li>
                <li><input name="siteHandOverDate" id="dateOfissue" placeholder="DD/MM/YYYY" class="datepicker form-control mb-md hasDatepicker">
               </li>
               </ul>
               
               <ul class="fs-list-details">
                <li><p>Agreement Concluded Date: <span class="red">*</span></p></li>
                <li><input name="agreementCouncludedDate" id="agreementConcludedDate" placeholder="DD/MM/YYYY" class="form-control mb-md hasDatepicker">
               </li>
               </ul>
               
               <ul class="fs-list-details">
                <li><p>Period of Contract (No. of Months): <span class="red">*</span></p></li>
                <li><input name="periodOfContract" id="contractPeriod" class="form-control mb-md" >
               </li>
               </ul>
               
               <ul class="fs-list-details">
                <li><p>Expected date of Completion as per Agreement: <span class="red">*</span></p></li>
                <li><input type="text" name="expectedCompletionDate" id="agreementExpectedDate" placeholder="DD/MM/YYYY" class="form-control mb-md" ><!-- readonly -->
               </li>
               </ul>
               
               <ul class="fs-list-details">
                <li><p>Agreement Number: <span class="red">*</span></p></li>
                <li><input type="text" name="agreementNumber" id="agreementNumber" class="form-control mb-md">
               </li>
               </ul>
