								...
								<fieldset>
									<div class="fs-list-full">
										...
										<ul class="fs-list-details">
											<li><p>
													Name of Work <span class="red">*</span>
												</p></li>
											<li><form:input type="text" id="workName"
													path="workName" class="form-control mb-md" readonly="true"
										...
										<ul class="fs-list-details">
											<li><p>
													Sanctioned Details <span class="red">*</span>
												</p></li>
											<li><form:input type="text" path="sanctionedDetails"
													id="sanctionedDetails" placeholder="AS Sanctioned Details "
													class="alpha-and-spaces" maxlength="50" /> <br>
											<span id="sanctionedDetailsErr" class="errors"
												style="color: red; float: right;"></span></li>
										</ul>

										<ul class="fs-list-details">
											<li><p>
													Grant<span class="red">*</span>
												</p></li>
											<li><form:select id="typeOfGrant" path="typeOfGrant.id">
											...
											<span id="typeOfGrantErr" class="errors"
												style="color: red; float: right;"></span></li>
										</ul>

										<ul class="fs-list-details">
											<li><p>
													Financial Year <span class="red">*</span>
												</p></li>
											<li><form:select id="financialYear"
											...
											<span id="financialYearErr" class="errors"
												style="color: red; float: right;"></span></li>
										</ul>

										<ul class="fs-list-details">
											<li><p>
													Engagement of executive dept by <span class="red">*</span>
												</p></li>
											<li><form:select id="executiveDept"
													path="executiveDept.id">
											...
											<span id="executiveDeptErr" class="errors"
												style="color: red; float: right;"></span></li>
										</ul>

										<ul class="fs-list-details">
											<li><p>
													Engagement of consultant by <span class="red">*</span>
												</p></li>
											<li><form:select id="consultant" path="consultant.id">
											...
											<span id="consultantErr" class="errors"
												style="color: red; float: right;"></span></li>
										</ul>
										...
										<div class="table-responsive">
											<table class="table table-hover mb-3 table-bordered">
												...
												<tbody id="landDetailsAttachmentsTable" class=" text-left">
													<c:forEach items="${adminAttachmentFiles}" var="file"
														varStatus="loop">
