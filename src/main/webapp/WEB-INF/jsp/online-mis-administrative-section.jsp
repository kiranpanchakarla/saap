        ...
        <form id="msform" method="post" action="adminSection"  modelAttribute="adminSecObject">
            ...
            <fieldset>
             <div class="fs-list-full"> 
                ...
                <li><input type="text" name="workName" placeholder="Name of Work"/></li>
                </ul>
                
                <ul class="fs-list-details">
                <li><p>Work Number <span class="red">*</span></p></li>
                <li><input type="text" name="workNumber" placeholder="Work Number"/></li>
                </ul>
                
                <ul class="fs-list-details">
                <li><p>AS Sanctioned Details <span class="red">*</span></p></li>
                <li><input type="text" name="sanctionedDetails" placeholder="AS Sanctioned Details "/></li>
                </ul>
                
                <ul class="fs-list-details">
                <li><p>Grant<span class="red">*</span></p></li>
                <li><select id="grantid" name="typeOfGrant">
                <option value="" selected="">--Types of Grant --</option>
                ...
                <li><select id="grantid" name="financialYear">
                ...
                <li><select id="grantid" name="executiveDept">
                <option value="" selected="">--Engagement of executive --</option>
                ...
                <li><select id="grantid" name="consultant">
                <option value="" selected="">--Engagement of consultant --</option>
                <option value="Govt">Govt</option>
                <option value="SAAP">SAAP</option>
                <option value="District Collector">District Collector</option>
                <option value="Others">Others</option>
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6 footer-links">
          ...
          <ul>
            ...
            <li> <a href="jsp/online-mis.html">Online Mis</a></li>
            <li> <a href="feedback.html">Feedback</a></li>
            <li> <a href="contact.html">Contact Us</a></li>
          </ul>
        </div>
