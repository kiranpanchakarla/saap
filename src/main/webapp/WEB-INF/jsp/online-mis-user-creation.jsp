...
<body>
  ...
  <div class="page-header">
	...
	<section id="contact" class="section-bg-con wow fadeInUp"
		style="visibility: visible; animation-name: fadeInUp;">
		<div class="container">
			<div class="row">
				<div class="col-md-6 offset-3" id="msform">
					<c:url value="/userCreation/save" var="createUrl" />
					<form role="form" method="post" action="${createUrl}"
						...
						<fieldset>
							...
							<div class="form-group">
								<input type="text" name="name" id="name"
									class="form-control input-lg" placeholder="Name"> <span
									id="nameErr" class="errors" style="color: red; float: right;"></span>
							</div>
							<div class="form-group">
								<input type="password" name="password" id="password"
									class="form-control input-lg" placeholder="Password"> <span
									id="passwordErr" class="errors"
									style="color: red; float: right;"></span>
							</div>
							<div class="form-group">
								<select id="userRole" name="userRole" class="form-control"
									placeholder="Role" style="height: auto;">
									<option value="" selected="" disabled="">--select
										Role--</option>
									<c:forEach var="roleList" items="${roleList}">
										<option value="${roleList.id}">${roleList.roleName}</option>
									</c:forEach>
								</select> <span id="userRoleErr" class="errors"
									style="color: red; float: right;"></span>
							</div>
							<div class="form-group">
								<input type="email" name="email" id="email"
									class="form-control input-lg" placeholder="Email"> <span
									id="emailErr" class="errors" style="color: red; float: right;"></span>
							</div>
							<div class="form-group">
								<input type="text" name="mobile" id="mobile"
									class="form-control input-lg" maxlength="10"
									placeholder="Number"> <span id="mobileErr"
									class="errors" style="color: red; float: right;"></span>
							</div>
							<div class="form-group">
								<textarea rows="4" name="address" id="address"
									class="form-control input-lg" placeholder="Enter address here"
									cols="50"></textarea>
								<span id="addressErr" class="errors"
									style="color: red; float: right;"></span>
							</div>
							<div>
								<input type="submit" id="submit" name="submit"
									class="next action-button" value="Register">
							</div>
