...
public class AttachmentDaoImpl implements AttachmentDao {
	...
	public List<Attachements> getAttachementsDetails(int workId, String moduleName) {
		...
		List<Attachements> attachments = sessionFactory.getCurrentSession().createQuery(
				"from Attachements where workId=" + workId + " and module='" + moduleName + "' and isActive='true' ")
				.list();
		return attachments;
	}
	...
	@Override
	public Attachements updateAttachement(Attachements attachInfo) {
